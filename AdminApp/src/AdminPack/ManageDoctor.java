...
public class ManageDoctor extends javax.swing.JFrame {
    ...
    public ManageDoctor(MainForm parent) {
        initComponents();
    ...
    public void updateDoctor() {
        ...
        try {
            ssql = "update doctor set did='" + jTextField5.getText() + "',fname='" + jTextField1.getText() + "',mname='" + jTextField2.getText() + "',lname='" + jTextField3.getText() + "',gender='" + gender + "',mobile='" + jTextField4.getText() + "',address='" + jTextArea1.getText() + "',email='" + jTextField7.getText() + "',specialization='" + jTextField8.getText() + "',rating=" + jTextField9.getText() + " where did='" + dId.elementAt(index) + "'";
    ...
    public void showData() {
        ...
        try {
            ssql = "select * from doctor where did=" + "'" + dId.elementAt(index) + "'";
            System.out.println("Query :" + ssql);
            stmt = parent.con.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_UPDATABLE);
    ...
    public void fillList() {
        ...
        try {
            ...
            stmt = parent.con.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_UPDATABLE);
            rs = stmt.executeQuery(ssql);
            dId = new Vector<String>();
            lm = new DefaultListModel();
            while (rs.next()) {
                lm.addElement(rs.getString(2) + "  " + rs.getString(4));
                dId.addElement(rs.getString(1));
            }
        } catch (Exception e) {
            System.out.println("Error Fetching data : " + e);
        }
    ...
    public void removeDoctor() {
        int index = jList1.getSelectedIndex();
        try {
            ssql = "delete from doctor where did='" + dId.elementAt(index) + "'";
            System.out.println("Query :" + ssql);
            stmt = parent.con.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_UPDATABLE);
            stmt.executeUpdate(ssql);
        } catch (Exception e) {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "MD", "MBBS" }));
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jLabel1, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 808, javax.swing.GroupLayout.PREFERRED_SIZE)
